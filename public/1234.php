...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change-password'])) {
    ...
    if (empty($currentPassword) || empty($newPassword) || empty($confirmPassword)) {
        ...
        $passwordError = 'New password must contain at least one lowercase letter, one uppercase letter, and one special character.';
    } else {
    ...
    <div class="profile-container">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="profile-form">
            ...
            <div class="button-container">
                ...
                <button type="submit" class="submit-btn" name="update-profile" style="display:none;">Save Changes</button>
            </div>
    ...
    <div class="password-container">
        <form action="#" method="POST" id="change-password-form">
            ...
            <div class="password-group">
                ...
                <span class="error-message" id="current-password-error"><?php echo htmlspecialchars($passwordError ?? ''); ?></span>
            </div>
            <div class="password-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    profileForm.addEventListener('submit', function(event) {
        ...
        if (isValid) {
            ...
            .then(data => {
                // Handle success/error based on server response
...
function validateChangePasswordForm(event) {
    ...
    if (!newPassword) {
        ...
        document.getElementById('new-password-error').innerText = 'Password must contain at least one lowercase, one uppercase, and one special character.';
        formIsValid = false;
    }
    if (!confirmPassword) {
...
.password-container .password-grid {
    display: grid;
...
.password-container .password-group {
    ...
    text-align: left; /* Ensures text alignment for labels and inputs */
}
...
.password-container .password-group input {
    ...
    margin: 0px; /* Remove auto-centering */
    text-align: left; /* Ensure input text aligns left */
}
